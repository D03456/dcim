...
| プラン | 利用期間 | DC | ラック | 機器 | サブネット | IP数 | タグ | ユーザー |
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| Free | 14日間 | 1 | 3 | 20 | 3 | 256 | 10 | 1 |
| Starter | 契約期間中 | 2 | 5 | 50 | 10 | 512 | 50 | 3 |
| Business | 契約期間中 | 5 | 50 | 100 | 50 | 1,024 | 200 | 10 |
| Enterprise | 契約期間中 | 10 | 100 | 1000 | 200 | 2,048 | 1000 | 30 |
...
管理対象IPについては、現在の有効な `ip_address` 件数 + 生成予定IP数 > プラン上限 の場合に上限超過とする。
```
...
- サブネット登録または個別IP生成時に、管理対象IP数上限を超えないこと。
